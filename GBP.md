...
Version 0.3.3
- Мелкие исправления ошибок предыдущих версий
- Исправлены проблемы во время скачивания модели
...
- AI-ядро: модель переводится в `eval()` и отключены градиенты — модель используется только для инференса.
